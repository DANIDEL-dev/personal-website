    ...
    return(
        <div>
            ...
            <div className="middle-container">
                ...
                <img className="my_pics" src={`${PUBLIC_URL}/image/me.jpg`} alt="Daniel" width="304"height="304"/>
                <h2>Hello.</h2>
                <p className="intro-1 touch" >I'm a software engineer, I believe every idea can be converted into reality.</p>
                <p className="intro-1 touch" >I'm also a Physicist & automation engineer </p>
                </div>
            </div>
        </div>   
