        ...
        <footer>
            ...
            <div id="c-mykelbot" className="c-mykelbot hide">
                ...
                <div className="o-flexy__item">
                    <img className="c-mykelbot_avatar" src={`${PUBLIC_URL}/image/me.jpg`} alt="Pic of Daniel backing the camera"/>
                </div>
                <div className="o-flexy__block">
                    <span className="c-mykelbot_name">Daniel's Bot</span>
                ...
                <div className="c-mykelbot_agent">
                    Hi! I’m Daniel's Personal Assistant 🤖
                </div>
            
                <div className="c-mykelbot_agent">
                    I’m just like Daniel, but a far better conversationalist 😉
                </div>
